...
from cross_exp.exp_crossformer_AIS import Exp_crossformer
from utils.tools import string_split

parser = argparse.ArgumentParser(description='CrossFormer')

parser.add_argument('--data', type=str,  default='JHT', help='data')
parser.add_argument('--data_path', type=str, default='/home/amos/haitundata', help='data file')  
