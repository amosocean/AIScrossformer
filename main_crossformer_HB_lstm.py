...
from cross_exp.exp_crossformer_HB import Exp_lstm as  Exp_crossformer
from utils.tools import string_split

parser = argparse.ArgumentParser(description='LSTM')

parser.add_argument('--data', type=str,  default='lstmFW3.sqlite', help='data')
parser.add_argument('--data_path', type=str, default='./FW3.sqlite', help='data file')  
parser.add_argument('--data_split', type=str, default='0.7,0.3',help='train/val/test split, can be ratio or number')
parser.add_argument('--checkpoints', type=str, default='./checkpoints/lstm', help='location to store model checkpoints')

parser.add_argument('--in_len', type=int, default=128, help='input MTS length (T)')
parser.add_argument('--out_len', type=int, default=128, help='output MTS length (\tau)')
...
parser.add_argument('--factor', type=int, default=4, help='num of routers in Cross-Dimension Stage of TSA (c)')

parser.add_argument('--data_dim', type=int, default=4, help='Number of dimensions of the MTS data (D)')
...
for ii in range(args.itr):
    ...
    setting = 'lstm_{}_il{}_ol{}_sl{}_win{}_fa{}_dm{}_nh{}_el{}_itr{}'.format(args.data, 
