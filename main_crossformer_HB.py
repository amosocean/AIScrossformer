...
from cross_exp.exp_crossformer_HB import Exp_crossformer
from utils.tools import string_split

parser = argparse.ArgumentParser(description='CrossFormer')

parser.add_argument('--data', type=str,  default='FW3.sqlite', help='data')
...
parser.add_argument('--out_len', type=int, default=40, help='output MTS length (\tau)')
...
parser.add_argument('--d_ff', type=int, default=1024, help='dimension of MLP in transformer')
parser.add_argument('--n_heads', type=int, default=8, help='num of heads')
parser.add_argument('--e_layers', type=int, default=10, help='num of encoder layers (N)')
